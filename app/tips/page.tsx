      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <Tabs value={selectedCategory} onValueChange={setSelectedCategory} className="w-full">
            <TabsList className="w-full h-auto p-1 bg-white/50 backdrop-blur-sm border border-gray-200 rounded-xl overflow-x-auto">
              <div className="flex gap-1 min-w-max">
                {categories.map((category) => (
                  <TabsTrigger
                    key={category}
                    value={category}
                    className="min-w-[70px] h-10 px-4 py-2 text-sm font-medium rounded-lg whitespace-nowrap
                             data-[state=active]:bg-[#4CAF50] data-[state=active]:text-white data-[state=active]:shadow-sm
